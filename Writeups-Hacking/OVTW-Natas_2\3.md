...
diccionario devolvera una "a" convertiendo a la palbra "hackers" en "ahackers" la cual no existe (respuesta vacia), en cambio si no esta la "a",
...
La respuesta sale entre etiquestas html <pre> y </pre> y si no hay respuesta "ej, ahackers" da un IndexError al no econtrar elementos, eso sera
